    ...
    <div class="g-content">
        ...
        <div class="m-query-form">
            <Form ref="queryForm" :model="queryForm" :rules="validate">
                ...
                <Form-item prop="msgContent" class="query-item">
                    <Input v-model="queryForm.msgContent" placeholder="消息内容"></Input>
                </Form-item>
                ...
                <Form-item class="query-item">
                    <Select v-model="queryForm.enabledState" placeholder="消息状态">
